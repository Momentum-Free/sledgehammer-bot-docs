...
const BlockList = [
  ...
  },
  {
    description: (
      <>
        Momentum Lancer LDA does not share or sell your personal information for advertising or marketing purposes. Additionally, we don’t share your personally identifying information with any third-parties, except when it is required by law.
      </>
    ),
  },
  {
  ...
  },
  {
    description: (
      <>
        If you have any questions or concerns regarding our privacy policies, please send us a detailed message to <a href="mailto:support@momentum-free.com">support@momentum-free.com</a>, and we will try to resolve your concerns.
      </>
    ),
  }
];
