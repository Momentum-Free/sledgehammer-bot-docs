...
const BlockList = [
  {
    description: (
      <>
        Welcome to Sledgehamer, a bot developed by{" "}
        <a href="https://momentum-one.io/">Momentum Lancer LDA</a>. Please read
        on to learn the rules and restrictions that govern your use of our
        website(s), products, services, proprietary bots, and other applications
        (the “Services”). If you have any questions, comments, or concerns
        regarding these terms or the Services, please contact us at Email:{" "}
        <a href="mailto:tos@momentum-one.io">TOS@momentum-one.io</a>
      </>
    ),
  },
  {
    description: (
      <>
        ...
        and <b>MOMENTUM LANCER LDA.</b> (“Momentum One,” “we” and “us”). Your
    ...
    description: (
      <>
        ...
        <b>
          ...
          and resolution of disputes by arbitration instead of in court. PLEASE
          NOTE THAT YOUR USE OF AND ACCESS TO OUR SERVICES ARE SUBJECT TO THE
          FOLLOWING TERMS; IF YOU DO NOT AGREE TO ALL OF THE FOLLOWING, YOU MAY
  ...
  },
  {
    ...
    description: (
      <>
        ...
        the Terms at any time, but if we do, we will place a notice by sending
  ...
  },
  {
    ...
    description: (
      <>
        Momentum One takes the privacy of its users very seriously. For the
        current Privacy Policy, please click <a href="/privacy-policy">here</a>.
        <br />
        <br />
        <i>Children’s Online Privacy Protection Act</i>
        <br />
        <br />
        ...
        identifiable information from children under sixteen (16); if you are a
        child under sixteen (16), please do not attempt to register for or
        otherwise use the Services or send us any personal information. If we
        learn we have collected personal information from a child under sixteen
        (16), we will delete that information as quickly as possible. If you
        believe that a child under sixteen (16) may have provided us personal
  ...
  },
  {
    description: (
      <>
        ...
        organization’s or entity’s behalf and bind them to these Terms (in which
  ...
  },
  {
    description: (
      <>
        ...
        Third-Party or any entity, and only in a manner that complies with all
    ...
    extraitem: (
      <ol type="a">
        <li>
          ...
          rights of anyone else (including Momentum One);
        </li>
        <li>
          ...
          reasonably intended by Momentum One;
        </li>
        <li>
        ...
        <li>
          jeopardizes the security of your account or anyone else’s (such as
  ...
  },
  {
    ...
    description: (
      <>
        ...
        that violates someone else’s (including Momentum One) rights.
      </>
    ),
  },
  {
    description: (
      <>
        ...
        understand that Momentum One owns the Services. You won’t modify,
  ...
  {
    title:
      "What about anything I contribute to the Services – do I have to grant any licenses to Momentum One or to other users?",
    description: (
      <>
        ...
        Submissions submitted by you are accurate, complete, up-to-date, and in
        compliance with all applicable laws, rules and regulations. <br />
        <br />
        ...
        third party’s copyrights or other rights (e.g., trademark, privacy
        ...
        hatred against any individual or group; (iv) exploit minors; (v) depict
        unlawful acts or extreme violence; (vi) depict animal cruelty or extreme
        violence towards animals; (vii) promote fraudulent schemes, multi-level
        marketing (MLM) schemes, get rich quick schemes, online gaming and
        gambling, cash gifting, work from home businesses, or any other dubious
  ...
  },
  {
    description: (
      <>
        ...
        <a href="/privacy-policy">Privacy Policy</a> to the extent they relate
        to User Submissions that are also your personally-identifiable
        information.
        <br />
        <br />
        By submitting User Submissions through the Services, you hereby do and
        shall grant Momentum One a worldwide, non-exclusive, perpetual,
        ...
        our affiliates’, our and their respective successors’ and assigns’)
        businesses, including without limitation for promoting and
        redistributing part or all of this site or the Services (and derivative
        works thereof), including the User Submissions contained therein, in any
        media formats and through any media channels (including, without
        limitation, Third-Party websites, social medias, and feeds), and
        including after your termination of your account or the Services. You
        also hereby do and shall grant each user of this site and/or the
        Services a non-exclusive, perpetual license to access your User
        Submissions through this site and/or the Services, and to use, edit,
        modify, reproduce, distribute, prepare derivative works of, display and
        perform such User Submissions, including after your termination of your
        account or the Services. For clarity, the foregoing license grants to us
        and our users do not affect your other ownership or license rights in
        your User Submissions, including the right to grant additional licenses
        to your User Submissions, unless otherwise agreed in writing. You
        represent and warrant that you have all rights to grant such licenses to
        us without infringement or violation of any Third-Party rights,
        ...
        you have an account (“Third-Party Accounts”). When Content is authorized
        for sharing, we will clearly identify the Content you are authorized to
        redistribute and the ways you may redistribute it, usually by providing
        a “share” button on or near the Content. If you share information from
        the Services with others through your Third-Party Accounts, such as your
        social networks, you authorize Momentum One to share that information
        with the applicable Third-Party Account provider. Please review the
        policies of any Third-Party Account providers you share information with
        or through for additional information about how they may use your
        information. If you redistribute Content, you must be able to edit or
        delete any Content you redistribute, and you must edit or delete it
        promptly upon our request. <br />
        <br />
        Finally, you understand and agree that Momentum One, in performing the
  ...
  },
  {
    ...
    description: (
      <>
        ...
        services that are not owned or controlled by Momentum One. When you
        access third-party websites or use third-party services, you accept that
        there are risks in doing so, and that Momentum One is not responsible
        for such risks. <br />
        <br />
        Momentum One has no control over, and assumes no responsibility for, the
        ...
        interact with through the Services. In addition, Momentum One will not
        ...
        Momentum One shall not be responsible or liable for any loss or damage
        ...
        between users and any third party, you agree that Momentum One is under
        no obligation to become involved. In the event that you have a dispute
        with one or more other users, you release Momentum One, its directors,
        ...
        waive Portugal Civil Code Section 1542 or any similar law of any
  ...
  {
    title: "Will Momentum One ever change the Services?",
    description: (
      <>
        ...
        affect you, but this isn’t always practical. We reserve the right to
        remove any Content from the Services at any time, for any reason
        (including, but not limited to, if someone alleges you contributed that
        Content in violation of these Terms), in our sole discretion, and
        without notice.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        If you’ll use the Services on behalf of any entity or any third party,
        please contact us at{" "}
        <a href="mailto:contact@momentum-one.io">contact@momentum-one.io</a> for
        the enterprise customer license agreement. We reserve the right to
        require payment of fees for certain or all Services.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        <a href="mailto:tos@momentum-one.io">TOS@momentum-one.io</a>; please
        refer to our <a href="/privacy-policy">Privacy Policy</a>, as well as
        the licenses above, to understand how we treat information you provide
        to us after you have stopped using our Services. If you are an
        administrator, you may disconnect the Service from your server at any
        time.
      </>
    ),
  },
  {
    description: (
      <>
        Momentum One is also free to terminate (or suspend access to) your use
        of the Services or your account for any reason in our discretion,
        including your breach of these Terms. Momentum One has the sole right to
  ...
  },
  {
    description: (
      <>
        ...
        <a href="mailto:tos@momentum-one.io">TOS@momentum-one.io</a> – we will
        try to help, but unfortunately, we can’t promise that we can recover or
        restore anything.
      </>
    ),
  },
  ...
  },
  {
    ...
    description: (
      <>
        <i>Warranty Disclaimer</i>. Momentum One and its licensors, suppliers,
        partners, parent, subsidiaries or affiliated entities, and each of their
        ...
        respective successors and assigns (Momentum One and all such parties
        together, the “Momentum One Parties”) make no representations or
        warranties concerning the Services, including without limitation
        regarding any Content contained in or accessed through the Services, and
        the Momentum One Parties will not be responsible or liable for the
        ...
        suits procedures, costs, expenses, damages or liabilities arising out of
        use of, or in any way related to your participation in, the Services.
        The Momentum One Parties make no representations or warranties regarding
        ...
        CONTENT ARE PROVIDED BY MOMENTUM ONE (AND ITS LICENSORS AND SUPPLIERS)
  ...
  },
  {
    description: (
      <>
        <i>Limitation of Liability</i>. TO THE FULLEST EXTENT ALLOWED BY
        ...
        OTHERWISE) SHALL ANY OF THE MOMENTUM ONE PARTIES BE LIABLE TO YOU OR TO
        ...
        AGGREGATE, IN EXCESS OF THE GREATER OF (I) ONE-HUNDRED ($100) DOLLARS OR
        (II) THE AMOUNTS PAID AND/OR PAYABLE BY YOU TO MOMENTUM ONE IN
        CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING
        THIS APPLICABLE CLAIM OR (D) ANY MATTER BEYOND OUR REASONABLE CONTROL.
  ...
  },
  {
    description: (
      <>
        <i>Indemnity</i>. You agree to indemnify and hold the Momentum One
        ...
        relating to (a) your use of the Services (including any actions taken by
        a Third-Party using your account), and (b) your violation of these
  ...
  },
  {
    description: (
      <>
        <i>Assignment</i>. You may not assign, delegate or transfer these Terms
        or your rights or obligations hereunder, or your Services account, in
        any way (by operation of law or otherwise) without Momentum One prior
  ...
  },
  {
    description: (
      <>
        <i>Choice of Law</i>. These Terms are governed by and will be construed
        under the Federal Arbitration Act, applicable federal law, and the laws
        of the Republic of Portugal without regard to the conflicts of laws
        provisions thereof.
      </>
    ),
  },
  {
    description: (
      <>
        <i>Arbitration Agreement</i>. Please read the following ARBITRATION
        AGREEMENT carefully because it requires you to arbitrate certain
        disputes and claims with Momentum One and limits the manner in which you
        can seek relief from Momentum One.Both you and Momentum One acknowledge
        and agree that for the purposes of any dispute arising out of or
        relating to the subject matter of these Terms, Momentum One officers,
        directors, employees and independent contractors(“Personnel”) are third
        - party beneficiaries of these Terms, and that upon your acceptance of
        these Terms, Personnel will have the right(and will be deemed to have
        accepted the right) to enforce these Terms against you as the third -
  ...
  },
  {
    description: (
      <>
        (a) <i>Arbitration Rules; Applicability of Arbitration Agreement</i>.
        ...
        shall be a precondition to either party initiating arbitration. If such
        negotiations do not resolve the dispute, it shall be finally settled by
        binding arbitration in Lisbon, Portugal. The arbitration will proceed in
        ...
        intellectual property and commercial contract disputes. The arbitrator
  ...
  },
  {
    description: (
      <>
        (b) <i>Costs of Arbitration</i>. Momentum One will not seek its
  ...
  },
  {
    description: (
      <>
        (c) <i>Small Claims Court; Infringement</i>. Either you or Momentum One
        may assert claims, if they qualify, in small claims court in Lisbon,
        Portugal or any United States county where you live or work.
        ...
        equitable relief at any time, from any court of competent jurisdiction,
  ...
  },
  {
    description: (
      <>
        (d) <i>Waiver of Jury Trial</i>. YOU AND MOMENTUM ONE WAIVE ANY
        CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN
        FRONT OF A JUDGE OR JURY. You and Momentum One are instead choosing to
        have claims and disputes resolved by arbitration. Arbitration procedures
        ...
        In any litigation between you and Momentum One over whether to vacate or
        enforce an arbitration award, YOU AND MOMENTUM ONE WAIVE ALL RIGHTS TO A
  ...
  },
  {
    description: (
      <>
        ...
        invalid or unenforceable, neither you nor Momentum One is entitled to
  ...
  },
  {
    description: (
      <>
        (f) <i>Opt-out</i>. You have the right to opt out of the provisions of
        this Section by sending written notice of your decision to opt out to
        the email <a href="mailto:tos@momentum-one.io">TOS@momentum-one.io</a>{" "}
        within thirty (30) days of first accepting these Terms. You must include
        (i) your name (ii) the email address and/or telephone number associated
        with your account, and (iii) a clear statement that you want to opt out
  ...
  },
  {
    description: (
      <>
        ...
        permits either you or Momentum One to litigate any dispute arising out
        of or relating to the subject matter of these Terms in court, then the
        foregoing arbitration agreement will not apply to either party, and both
        you and Momentum One agree that any judicial proceeding (other than
        small claims actions) will be brought in the state or federal courts
        located in, respectively, Lisbon, Portugal, or the federal district in
  ...
  },
  {
    description: (
      <>
        ...
        Services, provided that the Momentum One may, in its sole discretion, do
        ...
        provision of these Terms are found to be unenforceable or invalid, that
        ...
        effect and enforceable. You and Momentum One agree that these Terms are
        the complete and exclusive statement of the mutual understanding between
        you and Momentum One, and that these Terms supersede and cancel all
        ...
        joint venture of Momentum One, and you do not have any authority of any
        kind to bind Momentum One in any respect whatsoever.
      </>
    ),
  },
  {
    description: (
      <>
        ...
        arbitration agreement, you and Momentum One agree there are no
